...
public class SocialConfiguration implements SocialConfigurer {
	...
	public void addConnectionFactories(ConnectionFactoryConfigurer cfConfig, Environment env) {
		...
		// Facebook
		FacebookConnectionFactory fbfactory = new FacebookConnectionFactory(socialProperties.getFacebookAppId(),
				socialProperties.getFacebookAppSecret());
		fbfactory.setScope(socialProperties.getFacebookScope());
		cfConfig.addConnectionFactory(fbfactory);
	}
